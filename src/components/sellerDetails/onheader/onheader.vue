<template>
  <div class="header">
    ...
    <transition name="fade">
      <div class="detail" v-show="delailShow" >
      <div class="detail-wrapper clearfix" ref="header">
...
export default {
  ...
  methods: {
    showDetail () {
      this.delailShow = true
    },
    hideDetail () {
      this.delailShow = false
    }
  },
  created () {
    this.classMap = ['decrease', 'discount', 'special', 'invoice', 'guarantee']
    this.$nextTick(() => {
      this.scroll = new BScroll(this.$refs.header, {
        click: true
      })
    })
  },
