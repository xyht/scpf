<template>
  <div class="ratings" ref="ratingsBetterScroll">
          ...
          <li v-for="(rating,index) in ratings" :key="index" class="rating-item"  v-show="needShow(rating.rateType, rating.text)">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <star :size="34" :score="rating.score"></star>
...
import ratingselect from './../../../components/sellerDetails/ratingselect/ratingselect'
import split from './../../../components/sellerDetails/split/split'
  ...
  methods: {
    ...
    getData () {
      ...
      this.$http.get(url).then((response) => {
        ...
        this.$nextTick(() => {
          this.scroll = new BScroll(this.$refs.ratingsBetterScroll, {
            click: true
          })
        })
      })
